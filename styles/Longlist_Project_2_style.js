var size = 0;
var placement = 'point';
function categories_Longlist_Project_2(feature, value, size, resolution, labelText,
...
case 'Pelabuhan':
        ...
        image: new ol.style.Icon({
                  ...
                  anchorYUnits: "pixels",
                  rotation: 0.0,
                  src: "styles/transport_marina_1.svg"
            }),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
...
var style_Longlist_Project_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Longlist_Project_2(feature, value, size, resolution, labelText,
